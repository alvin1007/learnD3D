...
bool D3DClass::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen, float screenDepth, float screenNear)
{
	...
	if (FAILED(D3D11CreateDeviceAndSwapChain(NULL, D3D_DRIVER_TYPE_REFERENCE, NULL, 0, &featureLevel, 1,
	...
	/*
	 ...
	 2. D3D_DRIVER_TYPE_REFERENCE : 소위 표준 장치를 생성, 그래서 극도로 느리다. (하지만 난 개발자니까 쓸거임)
	 3. D3D_DRIVER_TYPE_SOFTWARE
